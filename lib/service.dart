...
class service extends StatefulWidget {
 static const String routeName = 'Servce';
  @override
          ...
          children:[
            ...
            Expanded(
              ...
              child:Row(
                ...
                children: [
                  Image.asset('assets/images/iconofservice.png',width:60,height:67,)
                ],
              ),
            ),
            Padding(
              ...
              child: Row(
               ...
               children: [
                 Text('Follow the periodic maintenance schedule and' '\n'
                     'pare parts change dates with the necessary alerts',style:TextStyle(fontWeight:FontWeight.bold)),
               ],
           ),
            ),
            Padding(
              ...
              child: Container(
                ...
                child: Column( crossAxisAlignment:CrossAxisAlignment.stretch,
                  children:[
                    Padding(
                      padding: const EdgeInsets.all(8.0),
                      child: TextFormField( initialValue:'Car Name',
                    ...
                    Padding(
                      padding: const EdgeInsets.all(8.0),
                      child: TextFormField( initialValue:'KM2',
